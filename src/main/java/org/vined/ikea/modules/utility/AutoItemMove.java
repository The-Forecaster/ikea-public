...
/*    */ {
    ...
    /* 24 */ private final Setting<List<net.minecraft.item.Item>> items = this.sgGeneral
            .add((Setting) ((ItemListSetting.Builder) ((ItemListSetting.Builder) (new ItemListSetting.Builder())
                    /* 25 */ .name("items"))
    ...
    /*    */ private void onTick(TickEvent.Post event) {
        ...
        /* 38 */ if (handler instanceof net.minecraft.screen.GenericContainerScreenHandler
                || handler instanceof net.minecraft.screen.ShulkerBoxScreenHandler) {
    ...
    /*    */ private int getRows(net.minecraft.screen.ScreenHandler handler) {
        /* 44 */ return (handler instanceof net.minecraft.screen.GenericContainerScreenHandler)
                ? ((net.minecraft.screen.GenericContainerScreenHandler) handler).getRows()
                : 3;
        /*    */ }
