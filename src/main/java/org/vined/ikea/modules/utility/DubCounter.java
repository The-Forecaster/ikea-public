...
/* 28 */       .name("load-time")
/* 29 */       .description("How much time it's going to take to load all the dubs. (useful if there are dubs out of render distance so you can load them or if you have a performance mod)")
...
/* 43 */     this.timer.reset();
/* 44 */     info("Please wait " + net.minecraft.util.Formatting.RED + this.loadTime.get() + net.minecraft.util.Formatting.GREEN + " second(s)...", new Object[0]);
/*    */   }
/*    */ 
/*    */   
...
/* 58 */         info("There are roughly " + net.minecraft.util.Formatting.BOLD + dubs + net.minecraft.util.Formatting.GOLD + " (" + length + " normal chests) rendered double chests.", new Object[0]);
/* 59 */         toggle();
/*    */       } else {
/* 61 */         int fixed = length - 1;
/* 62 */         int dubs = fixed / 2;
/* 63 */         info("There are roughly " + net.minecraft.util.Formatting.GOLD + dubs + net.minecraft.util.Formatting.BOLD + " (" + fixed + " normal chests) rendered double chests.", new Object[0]);
/* 64 */         toggle();
/*    */       } 
/* 66 */       this.timer.reset();
/*    */     } 
...
/* 73 */     if (block instanceof net.minecraft.block.entity.ChestBlockEntity) { net.minecraft.block.entity.ChestBlockEntity chest = (net.minecraft.block.entity.ChestBlockEntity)block;
