...
/*    */   
/* 25 */   private final Setting<Integer> radius = this.sgGeneral.add((Setting)((IntSetting.Builder)((IntSetting.Builder)((IntSetting.Builder)(new IntSetting.Builder())
...
/*    */ 
/*    */   
/* 34 */   private final Setting<Integer> partyModeMin = this.sgParty.add((Setting)((IntSetting.Builder)((IntSetting.Builder)((IntSetting.Builder)(new IntSetting.Builder())
...
/*    */ 
/*    */   
/* 44 */   private final Setting<Integer> partyModeMax = this.sgParty.add((Setting)((IntSetting.Builder)((IntSetting.Builder)((IntSetting.Builder)(new IntSetting.Builder())
...
/*    */ 
/*    */   
/* 54 */   private final Setting<Boolean> partyMode = this.sgParty.add((Setting)((BoolSetting.Builder)((BoolSetting.Builder)((BoolSetting.Builder)(new BoolSetting.Builder())
/* 55 */       .name("party-mode"))
...
/* 70 */       if (((Integer)this.partyModeMin.get()).intValue() > ((Integer)this.partyModeMax.get()).intValue()) {
/* 71 */         info("The party mode minimum can't be bigger than the party mode maximum, setting the minimum to 0...", new Object[0]);
...
/*    */       }
/* 82 */       else if (((Integer)this.radius.get()).intValue() >= ((Integer)this.partyModeMax.get()).intValue()) {
